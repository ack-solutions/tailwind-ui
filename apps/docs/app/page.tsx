    ...
    <div className="space-y-16">
      ...
      <section className="text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button as={Link} href="/getting-started" size="lg">Get Started</Button>
          <Button as={Link} href="/components" variant="outline" size="lg">Browse Components</Button>
          <Button as="a" href="https://github.com" variant="ghost" size="lg">
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="text-center space-y-6 py-16 border-t border-border">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button as={Link} href="/installation" size="lg">View Installation Guide</Button>
          <Button as={Link} href="/components" variant="outline" size="lg">Explore Components</Button>
        </div>
      </section>
    </div>
  );
